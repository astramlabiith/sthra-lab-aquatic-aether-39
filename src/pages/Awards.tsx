...
import { Award, Trophy, Medal, Star, GraduationCap, Users, FileBadge } from 'lucide-react';
...
const labAwards = [
  {
    ...
    description: "Recognized for the highest quality technical presentation and visual communication among all international submissions at the IEEE Applied Sensing Conference (APSCON).",
    icon: FileBadge,
  },
  {
    year: "2026",
...
const Awards = () => {
  ...
  const tabs = [
    { id: 'pi' as const, name: 'Principal Investigator', icon: GraduationCap },
    { id: 'lab' as const, name: 'Lab Awards & Recognitions', icon: Users },
  ];
  const awards = activeTab === 'pi' ? piAwards : labAwards;
